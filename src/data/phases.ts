...
export const phases: Phase[] = [
  {
    ...
    genres: [
      ...
      },
      {
        ...
        name: "Cool Jazz",
        bpm: "110–140",
        timing: "4/4 (Laid-Back Swing)",
        description:
          "West Coast chill: airy horns, brushed drums, and smooth ii–V–I lines.",
        key: "Bb Major (example)",
        progression: "ii7 – V7 – Imaj9",
        progressionNote:
          "Standard jazz cadence but voiced with close-position 9ths for softness.",
        progressionChords: [
          {
            degree: "ii7",
            symbol: "Cm7",
            shape: "min7",
            note: "Gentle pre-dominant; use guide tones and 9.",
          },
          {
            degree: "V7",
            symbol: "F13",
            shape: "Dom9",
            note: "Lightly accented dominant; often altered but still relaxed.",
          },
          {
            degree: "Imaj9",
            symbol: "Bbmaj9",
            shape: "Maj7",
            note: "Soft landing with lush 9 on top.",
          },
        ],
        instruments: {
          piano: "Sparse comping with quartal colors and lots of space.",
          guitar: "Soft Freddie Green-style grips with added 9s.",
          ukulele: "Featherlight swing strum on shell voicings.",
        },
        visual_chord: "Maj7",
        key_traits: ["Subtle Dynamics", "Close Voicings", "Airy Textures"],
      },
      {
        id: "hard-bop",
        name: "Hard Bop",
        bpm: "160–200",
        timing: "4/4 (Driving Swing)",
        description:
          "Earthy extension of bebop with blues heads and churchy turnarounds.",
        key: "F Minor (example)",
        progression: "i7 – iv7 – ♭VI7 – V7alt",
        progressionNote:
          "Minor blues language with altered dominants and gospel cadences.",
        progressionChords: [
          {
            degree: "i7",
            symbol: "Fm7",
            shape: "min7",
            note: "Minor tonic; room for 9/11 extensions.",
          },
          {
            degree: "iv7",
            symbol: "Bbm7",
            shape: "min7",
            note: "Subdominant color from the blues.",
          },
          {
            degree: "♭VI7",
            symbol: "Db7",
            shape: "Dom7",
            note: "Tritone pull into the altered V.",
          },
          {
            degree: "V7alt",
            symbol: "C7alt",
            shape: "Dom7",
            note: "Altered dominant for gritty resolution back to i.",
          },
        ],
        instruments: {
          piano: "Horace Silver-style gospel shells and blues licks.",
          guitar: "Aggressive downbeat comps; mix blues bends with bop lines.",
          ukulele: "Punchy off-beat chops outlining tritone motion.",
        },
        visual_chord: "Dom7",
        key_traits: ["Gospel Cadences", "Altered Dominants", "Blues Heads"],
      },
      {
        id: "gypsy-jazz",
        name: "Gypsy Jazz",
        ...
        timing: "4/4 (La Pompe)",
        description:
          "Django-inspired swing with percussive acoustic rhythm and rapid arpeggios.",
        key: "A Minor (example)",
        progression: "i – VI7 – iiø – V7",
        progressionNote:
          "Minor circle-of-fifths turnaround with chromatic dominant color.",
        progressionChords: [
          {
            degree: "i",
            symbol: "Am6",
            shape: "min7",
            note: "Minor tonic often voiced with 6 for vintage color.",
          },
          {
            degree: "VI7",
            symbol: "F#7",
            shape: "Dom7",
            note: "Secondary dominant propelling toward iiø.",
          },
          {
            degree: "iiø",
            symbol: "Bm7b5",
            shape: "m7b5",
            note: "Half-diminished step to the dominant.",
          },
          {
            degree: "V7",
            symbol: "E7",
            shape: "Dom7",
            note: "Bright dominant, often embellished with #9 or b9.",
          },
        ],
        instruments: {
          piano: "If present, doubles basslines and chromatic runs.",
          guitar:
            "Relentless 'la pompe' rhythm on acoustic archtops plus rapid arpeggios.",
          ukulele: "Short, percussive down-up pattern mirroring la pompe accents.",
        },
        visual_chord: "min7",
        key_traits: ["La Pompe", "Chromatic Runs", "Acoustic Attack"],
      },
    ],
  },
  {
    ...
    genres: [
      ...
      },
      {
        ...
        name: "Ska",
        bpm: "120–160",
        timing: "4/4 (Offbeat Skank)",
        description:
          "Jamaican shuffle with guitar/piano hits on the offbeats and walking bass.",
        key: "G Major (example)",
        progression: "I – IV – V",
        progressionNote: "Simple triadic harmony; energy comes from rhythm guitar chops.",
        progressionChords: [
          { degree: "I", symbol: "G", shape: "Maj7", note: "Bright tonic." },
          { degree: "IV", symbol: "C", shape: "Maj7", note: "Subdominant lift." },
          { degree: "V", symbol: "D", shape: "Maj7", note: "Dominant push." },
        ],
        instruments: {
          piano: "Short skank chords on the & of each beat.",
          guitar: "Upstroke offbeat chops with light palm mute.",
          ukulele: "Tight offbeat strum locking with hi-hat.",
        },
        visual_chord: "Maj7",
        key_traits: ["Offbeat Skank", "Walking Bass", "Bright Horns"],
      },
      {
        id: "rocksteady",
        name: "Rocksteady",
        ...
        timing: "4/4 (Relaxed)",
        description:
          "Slower, more soulful evolution of ska with heavier bass presence.",
        progression: "I – vi – IV – V",
        progressionNote: "Classic pop loop translated to the Caribbean groove.",
        progressionChords: [
          { degree: "I", symbol: "A", shape: "Maj7", note: "Tonic anchor." },
          { degree: "vi", symbol: "F#m", shape: "min7", note: "Relative minor color." },
          { degree: "IV", symbol: "D", shape: "Maj7", note: "Warm lift." },
          { degree: "V", symbol: "E", shape: "Dom7", note: "Return to the top." },
        ],
        instruments: {
          piano: "Sparse, warm comps on 2 and 4.",
          guitar: "Gentle offbeat chops with more sustain than ska.",
          ukulele: "Laid-back strum with emphasis on backbeats.",
        },
        visual_chord: "Maj7",
        key_traits: ["Slow Skank", "Soulful Vocals", "Heavy Bass"],
      },
      {
        id: "reggae",
        name: "Reggae",
        ...
        timing: "4/4 (One-Drop)",
        description:
          "Backbeat-driven grooves with lots of space and syncopated bass.",
        key: "A Major (example)",
        progression: "I – V – vi – IV",
        progressionNote:
          "Pop-friendly harmony but drums emphasize beat 3 (one-drop).",
        progressionChords: [
          { degree: "I", symbol: "A", shape: "Maj7", note: "Tonic." },
          { degree: "V", symbol: "E", shape: "Dom7", note: "Dominant flavor." },
          { degree: "vi", symbol: "F#m7", shape: "min7", note: "Minor warmth." },
          { degree: "IV", symbol: "Dmaj7", shape: "Maj7", note: "Lift before loop." },
        ],
        instruments: {
          piano: "Bubble pattern on 2 and 4 with light staccato.",
          guitar: "Short skank chords; mute quickly.",
          ukulele: "Backbeat chops aligned with hi-hat and snare.",
        },
        visual_chord: "Maj7",
        key_traits: ["One-Drop", "Space", "Syncopated Bass"],
      },
      {
        id: "afrobeat",
        name: "Afrobeat",
        ...
        timing: "4/4 (Groove)",
        description:
          "Fela-inspired long-form jams with horn riffs, call-and-response, and political lyrics.",
        key: "G Dorian (example)",
        progression: "i7 – IV7 vamp",
        progressionNote:
          "Harmony stays static so rhythm section can interlock intricate patterns.",
        progressionChords: [
          { degree: "i7", symbol: "Gm7", shape: "min7", note: "Modal tonic center." },
          { degree: "IV7", symbol: "C9", shape: "Dom9", note: "Brassy lift against tonic." },
        ],
        instruments: {
          piano: "Clave-informed polyrhythms reinforcing percussion.",
          guitar: "Interlocking single-note riffs and palm-muted triads.",
          ukulele: "Repeated ostinatos locking with shakers.",
        },
        visual_chord: "Dom9",
        key_traits: ["Polyrhythm", "Long Vamps", "Horn Riffs"],
      },
      {
        id: "p-funk",
        name: "P-Funk",
        ...
        timing: "4/4 (Greasy)",
        description:
          "Parliament / Funkadelic cosmos: synth bass, chants, and psychedelic clav grooves.",
        key: "E Mixolydian (example)",
        progression: "I7 vamp with IV hits",
        progressionNote:
          "Static dominant vamp that occasionally jumps to IV for crowd response.",
        progressionChords: [
          { degree: "I7", symbol: "E7#9", shape: "Dom7", note: "The One, extra nasty." },
          { degree: "IV7", symbol: "A13", shape: "Dom9", note: "Call-and-response lift." },
        ],
        instruments: {
          piano: "Clavinet scratches with wah and syncopation.",
          guitar: "Palm-muted 16th-note grids, occasional fuzz leads.",
          ukulele: "Ghost-note heavy chanks on the upper strings.",
        },
        visual_chord: "Dom7",
        key_traits: ["Synth Bass", "Call-and-Response", "Greasy Dominants"],
      },
      {
        id: "boogie",
        name: "Boogie",
        bpm: "105–120",
        timing: "4/4 (Shuffle Meets Four-on-the-Floor)",
        description:
          "Bridge between funk and modern R&B: slap bass, electric piano, and early drum machines.",
        key: "D Major (example)",
        progression: "ii7 – V7 – Imaj7",
        progressionNote: "Funked-up ii–V–I with synth bass hooks.",
        progressionChords: [
          { degree: "ii7", symbol: "Em7", shape: "min7", note: "Sets up dominant." },
          { degree: "V7", symbol: "A13", shape: "Dom9", note: "Extended funk dominant." },
          { degree: "Imaj7", symbol: "Dmaj7", shape: "Maj7", note: "Glossy resolution." },
        ],
        instruments: {
          piano: "Rhodes stabs with chorus and syncopated fills.",
          guitar: "Bright chanks and octave riffs à la Shalamar.",
          ukulele: "Muted 16th-note feel emphasizing groove over harmony.",
        },
        visual_chord: "Maj7",
        key_traits: ["Slap Bass", "Drum Machines", "Glossy Keys"],
      },
      {
        id: "disco",
        name: "Disco",
  ...
  },
  {
    ...
    genres: [
      ...
      },
      {
        ...
        bpm: "Varies",
        timing: "Odd meters + 4/4",
        description:
          "Rock meets classical/jazz forms: long songs, modulations, and pedal points.",
        key: "E Minor (example)",
        progression: "i – ♭VII – IV – i",
        progressionNote:
          "Modal harmony over ostinatos; sections often change meter and key.",
        progressionChords: [
          { degree: "i", symbol: "Em", shape: "min7", note: "Minor pedal center." },
          { degree: "♭VII", symbol: "D", shape: "Maj7", note: "Mixolydian color." },
          { degree: "IV", symbol: "C", shape: "Maj7", note: "Bright lift before returning." },
        ],
        instruments: {
          piano: "Hammond or Mellotron pads, thematic arpeggios.",
          guitar: "Riff-based power chords with odd-meter accents.",
          ukulele: "Simplified chord hits on strong beats for meter clarity.",
        },
        visual_chord: "min7",
        key_traits: ["Odd Meters", "Pedal Points", "Suite Forms"],
      },
      {
        id: "latin-jazz-fusion",
        name: "Latin Jazz Fusion",
        bpm: "120–150",
        timing: "4/4 + clave feels",
        description:
          "Salsa and samba rhythms blended with jazz harmony and electric instruments.",
        key: "A Dorian (example)",
        progression: "ii7 – V7 – i7 with montuno",
        progressionNote:
          "Minor ii–V–i flavored with clave phrasing and montuno piano figures.",
        progressionChords: [
          { degree: "ii7", symbol: "Bm7b5", shape: "m7b5", note: "Half-diminished pre-dominant." },
          { degree: "V7", symbol: "E7b9", shape: "Dom7", note: "Altered dominant with Latin hits." },
          { degree: "i7", symbol: "Am9", shape: "min9", note: "Minor tonic with lush extensions." },
        ],
        instruments: {
          piano: "Montuno patterns locking to clave and tumbao bass.",
          guitar: "Percussive comping with occasional jazz lines.",
          ukulele: "Syncopated upper-structure triads on offbeats.",
        },
        visual_chord: "min9",
        key_traits: ["Clave", "Montuno", "Altered Dominants"],
      },
      {
        id: "sophisti-pop",
        name: "Sophisti-Pop",
        ...
        timing: "4/4",
        description:
          "Glossy UK/Euro pop with jazz chords, sax hooks, and clean production.",
        key: "Db Major (example)",
        progression: "ii7 – V7sus – Imaj9",
        progressionNote:
          "Jazz-pop cadence with suspended dominants to keep things smooth.",
        progressionChords: [
          { degree: "ii7", symbol: "Ebm7", shape: "min7", note: "Soft pre-dominant." },
          { degree: "V7sus", symbol: "Ab13sus", shape: "Dom9", note: "Suspended dominant avoids harshness." },
          { degree: "Imaj9", symbol: "Dbmaj9", shape: "Maj7", note: "Lush tonic resolution." },
        ],
        instruments: {
          piano: "Electric piano pads with tasteful reverb.",
          guitar: "Clean chorus tones outlining 9/11 extensions.",
          ukulele: "Light strums on maj7/add9 grips to keep shimmer.",
        },
        visual_chord: "Maj7",
        key_traits: ["Chorus FX", "Maj7/9", "Sax Hooks"],
      },
      {
        id: "italo-disco",
        name: "Italo Disco",
        bpm: "115–125",
        timing: "4/4 (Euro Dance)",
        description:
          "Synth-forward European disco with arpeggiators and dramatic minor hooks.",
        key: "Em (example)",
        progression: "i – VI – III – VII",
        progressionNote:
          "Aeolian loop that supports endless synth melodies.",
        progressionChords: [
          { degree: "i", symbol: "Em", shape: "min7", note: "Driving minor tonic." },
          { degree: "VI", symbol: "C", shape: "Maj7", note: "Hopeful lift." },
          { degree: "III", symbol: "G", shape: "Maj7", note: "Anthemic release." },
          { degree: "VII", symbol: "D", shape: "Dom7", note: "Dominant flavor before looping." },
        ],
        instruments: {
          piano: "Sequenced synth stabs and arps.",
          guitar: "Occasional funk scratches layered under synths.",
          ukulele: "Simple downbeat pulses doubling synth chords.",
        },
        visual_chord: "min7",
        key_traits: ["Arpeggiators", "Minor Hooks", "Euro Reverb"],
      },
      {
        id: "new-wave",
        name: "New Wave / Synthpop",
        bpm: "110–130",
        timing: "4/4 (Machine Backbeat)",
        description:
          "Post-punk sheen: drum machines, gated reverb, and bright synth chords.",
        key: "A Major (example)",
        progression: "I – V – vi – IV",
        progressionNote: "Pop diatonic loop with robotic percussion layers.",
        progressionChords: [
          { degree: "I", symbol: "A", shape: "Maj7", note: "Shimmering tonic." },
          { degree: "V", symbol: "E", shape: "Dom7", note: "Tight backbeat accent." },
          { degree: "vi", symbol: "F#m7", shape: "min7", note: "Emotional contrast." },
          { degree: "IV", symbol: "D", shape: "Maj7", note: "Pre-chorus lift." },
        ],
        instruments: {
          piano: "Synth pads with gated reverb stabs.",
          guitar: "Chorus-soaked triads with palm-muted 8ths.",
          ukulele: "Steady down-up pattern mirroring machine precision.",
        },
        visual_chord: "Maj7",
        key_traits: ["Drum Machines", "Gated Reverb", "Synth Hooks"],
      },
    ],
  },
  {
    ...
    genres: [
      ...
      },
      {
        ...
        timing: "4/4",
        description:
          "Pre-City Pop Japanese popular song: Showa-era melodies with Western harmony.",
        key: "G Major (example)",
        progression: "I – vi – IV – V",
        progressionNote: "Sentimental loop that set the stage for later Royal Road hooks.",
        progressionChords: [
          { degree: "I", symbol: "G", shape: "Maj7", note: "Simple tonic." },
          { degree: "vi", symbol: "Em", shape: "min7", note: "Melancholic drop." },
          { degree: "IV", symbol: "C", shape: "Maj7", note: "Hopeful lift." },
          { degree: "V", symbol: "D7", shape: "Dom7", note: "Dominant back home." },
        ],
        instruments: {
          piano: "Orchestral-style block chords and countermelodies.",
          guitar: "Clean strums supporting vocal melody.",
          ukulele: "Gentle down-up pattern reinforcing harmony.",
        },
        visual_chord: "Maj7",
        key_traits: ["Showa Melodies", "Sentimental", "Pre-Royal Road"],
      },
      {
        id: "shibuya-kei",
        name: "Shibuya-kei",
        ...
        timing: "4/4",
        description:
          "Tokyo indie pop blending bossa nova, baroque pop, and sampling culture.",
        progression: "ii7 – V7 – Imaj7 with borrowed chords",
        progressionNote:
          "Jazz-pop cadences sprinkled with French pop and lounge-influenced modulations.",
        progressionChords: [
          { degree: "ii7", symbol: "Dm7", shape: "min7", note: "Soft pre-dominant." },
          { degree: "V7", symbol: "G13", shape: "Dom9", note: "Extended dominant with color." },
          { degree: "Imaj7", symbol: "Cmaj7", shape: "Maj7", note: "Smooth resolution, often followed by borrowed IVm." },
        ],
        instruments: {
          piano: "Wurlitzer/Rhodes comps plus sample chops.",
          guitar: "60s-style clean chords and melodic riffs.",
          ukulele: "Bossa-inspired strums that match the lounge vibe.",
        },
        visual_chord: "Maj7",
        key_traits: ["Eclectic Sampling", "Bossa Influence", "Cute Hooks"],
      },
      {
        id: "j-fusion",
        name: "J-Fusion",
        ...
        timing: "4/4",
        description:
          "Casiopea/T-Square style virtuosic fusion with pristine production.",
        key: "E Mixolydian (example)",
        progression: "I13 – IVmaj9 – V13",
        progressionNote:
          "Extended dominant language with bright Lydian and Mixolydian colors.",
        progressionChords: [
          { degree: "I13", symbol: "E13", shape: "Dom9", note: "Funky tonic dominant." },
          { degree: "IVmaj9", symbol: "Amaj9", shape: "Maj7", note: "Lydian lift with #11 options." },
          { degree: "V13", symbol: "B13", shape: "Dom9", note: "Dominant push into solos or modulations." },
        ],
        instruments: {
          piano: "Sparkling synth leads and Rhodes comping.",
          guitar: "Fusion leads with chorus and precise staccato chords.",
          ukulele: "Tight 16th-note support on upper extensions.",
        },
        visual_chord: "Dom9",
        key_traits: ["Virtuosity", "Bright Mix", "Extended Dominants"],
      },
    ],
  },
  {
    ...
    genres: [
      ...
      },
      {
        ...
        bpm: "80–110",
        timing: "4/4 (Driving 8ths)",
        description:
          "Retro-futurist pads, analog basslines, and tom-heavy drum machines.",
        key: "Fm (example)",
        progression: "i – VI – III – VII",
        progressionNote: "Classic 80s minor loop powering neon nostalgia.",
        progressionChords: [
          { degree: "i", symbol: "Fm", shape: "min7", note: "Dark tonic." },
          { degree: "VI", symbol: "Db", shape: "Maj7", note: "Lift toward hope." },
          { degree: "III", symbol: "Ab", shape: "Maj7", note: "Anthemic crest." },
          { degree: "VII", symbol: "Eb", shape: "Dom7", note: "Resolves back into the loop." },
        ],
        instruments: {
          piano: "Synth pads and brassy stabs with long reverb.",
          guitar: "Occasional chorus leads doubling melodies.",
          ukulele: "Straight 8ths supporting pad harmony.",
        },
        visual_chord: "min7",
        key_traits: ["Analog Bass", "Gated Reverb", "Neon Nostalgia"],
      },
      {
        id: "k-pop",
        name: "K-Pop",
        ...
        timing: "4/4",
        description:
          "Hybrid pop production mixing trap drums, EDM builds, and bright major hooks.",
        key: "Bb Major (example)",
        progression: "I – V – vi – IV with rap breaks",
        progressionNote: "Sectional writing: key changes and drops are common.",
        progressionChords: [
          { degree: "I", symbol: "Bb", shape: "Maj7", note: "Shiny tonic." },
          { degree: "V", symbol: "F", shape: "Dom7", note: "Pre-chorus drive." },
          { degree: "vi", symbol: "Gm7", shape: "min7", note: "Emotional color." },
          { degree: "IV", symbol: "Eb", shape: "Maj7", note: "Soaring lift into chorus." },
        ],
        instruments: {
          piano: "Plucky synth leads and supersaw pads.",
          guitar: "Filtered funk chops layered with synth brass.",
          ukulele: "Occasional bright strums in acoustic sections.",
        },
        visual_chord: "Maj7",
        key_traits: ["Hybrid Sections", "Modulations", "Layered Vocals"],
      },
      {
        id: "trap",
        name: "Trap",
        bpm: "130–150",
        timing: "4/4 (Half-Time Feel)",
        description:
          "808 subs, skittering hi-hats, and minor-key pads with minimal harmony.",
        key: "C Minor (example)",
        progression: "i – VI – VII",
        progressionNote: "Looped minor triads under half-time drums and melodic vocals.",
        progressionChords: [
          { degree: "i", symbol: "Cm", shape: "min7", note: "Sub-heavy tonic." },
          { degree: "VI", symbol: "Ab", shape: "Maj7", note: "Lift without losing mood." },
          { degree: "VII", symbol: "Bb", shape: "Dom7", note: "Keeps loop moving." },
        ],
        instruments: {
          piano: "Filtered minor pads and bell plucks.",
          guitar: "Sparse melodic motifs or reversed samples.",
          ukulele: "Soft arpeggios if used; keep space for vocals.",
        },
        visual_chord: "min7",
        key_traits: ["808 Sub", "Half-Time", "Sparse Harmony"],
      },
      {
        id: "edm-house",
        name: "EDM / House",
        ...
        timing: "4/4 (Four-on-the-Floor)",
        description:
          "Club-focused grooves with sidechained pads and big builds/drops.",
        key: "F Minor (example)",
        progression: "i – VI – III – VII",
        progressionNote: "Loop-friendly Aeolian cycle built for filters and risers.",
        progressionChords: [
          { degree: "i", symbol: "Fm", shape: "min7", note: "Driving tonic." },
          { degree: "VI", symbol: "Db", shape: "Maj7", note: "Hands-up lift." },
          { degree: "III", symbol: "Ab", shape: "Maj7", note: "Release before drop." },
          { degree: "VII", symbol: "Eb", shape: "Dom7", note: "Return to start with tension." },
        ],
        instruments: {
          piano: "Sidechained saw pads and pluck leads.",
          guitar: "Occasional disco-style octave riffs.",
          ukulele: "Percussive chops in breakdowns for organic texture.",
        },
        visual_chord: "min7",
        key_traits: ["Sidechain", "Build/Drop", "Four-on-the-Floor"],
      },
      {
        id: "drum-and-bass",
        name: "Drum & Bass",
        bpm: "160–175",
        timing: "4/4 (Breakbeats)",
        description:
          "Amen breaks, heavy subs, and minor-mode pads at blistering tempos.",
        key: "D Minor (example)",
        progression: "i – VI",
        progressionNote: "Harmony stays static so drums and bass variations shine.",
        progressionChords: [
          { degree: "i", symbol: "Dm7", shape: "min7", note: "Minor pad center." },
          { degree: "VI", symbol: "Bbmaj7", shape: "Maj7", note: "Brief lift in breakdowns." },
        ],
        instruments: {
          piano: "Filtered pads and atmospheric textures.",
          guitar: "Rare; occasional reverb-washed swells.",
          ukulele: "Arp-like plucks during intros/outros.",
        },
        visual_chord: "min7",
        key_traits: ["Breakbeats", "Sub Bass", "Pads"],
      },
    ],
  },
];
